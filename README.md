...
12. [View Output via minicom or PuTTY](#12-view-output-via-minicom-or-putty)
...
- minicom or PuTTY for serial output
...
**Enable USART2 for serial output**
...
> ℹ️ On STM32F401RE Nucleo, **USART2** is wired to the ST-LINK USB virtual COM port. No extra wires or USB-TTL adapter needed.
...
## 12. View Output via minicom or PuTTY

The STM32F401RE Nucleo has a **built-in ST-LINK USB** that exposes USART2 as a virtual COM port. No extra hardware needed.
...
### Give permission to access the port
...
Settings inside minicom (press `Ctrl+A` then `Z` for menu):
- Baud rate: `115200`
- Data bits: `8`
- Parity: `None`
- Stop bits: `1`
...
| No output in terminal | Wrong COM port or baud rate | Check `/dev/ttyACM0`, set baud to `115200` |
